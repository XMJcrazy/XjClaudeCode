...
class ToolReadFile(ToolBase):
    ...
    async def execute(self, sd: SessionCtx, file_path: str, limit: int = None) -> ToolResp:
...
class ToolWriteFile(ToolBase):
    ...
    async def execute(self, sd: SessionCtx, file_path: str, content: str) -> ToolResp:
...
class ToolEditFile(ToolBase):
    ...
    async def execute(self, sd: SessionCtx, file_path: str, old_text: str, new_text: str) -> ToolResp:
        fp = safe_path(file_path, sd.session.white_path)
